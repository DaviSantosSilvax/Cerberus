...
export default function SideBar() {
    ...
    const sideBarItems = [
        ...
        { id: "Câmeras", label: "Câmeras", icon: Video },
    ...
    return (
        <div className="shadow-[10px_0_30px_rgba(15,124,250,0.15)] gap-10 w-80 flex flex-col items-center max-w-100 h-screen border-r-2 border-[#2920d6] bg-linear-to-br from-[#050569] via-[#06023b] to-[#080536] backdrop-blur-[10px]">
