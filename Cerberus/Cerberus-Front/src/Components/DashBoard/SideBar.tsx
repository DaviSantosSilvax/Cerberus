...
import { House, Video, Bot, Snowflake, Lightbulb, AlarmClockCheck, Diamond, ShieldCheck, Music, FileClock, Cctv } from "lucide-react"
...
export default function SideBar() {
    ...
    const sideBarItems = [
        ...
        { id: "Cerberus", label: "Cerberus", icon: Bot, rota: "/cerberus" },
    ];
